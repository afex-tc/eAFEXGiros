...
<!--
	...
	sub imgAceptar_onclick()
		frmExiste.action = "http:venderTarjeta.asp?sw "& sw 
		frmExiste.submit 
		frmExiste.action = ""
	end sub
-->
...
<table align="left" STYLE="BORDER-BOTTOM: steelblue 2px solid; BORDER-LEFT: steelblue 2px solid; BORDER-RIGHT: steelblue 2px solid; BORDER-TOP: steelblue 2px solid;  HEIGHT: 80px; LEFT: 4px; POSITION: relative; TOP: 0px; WIDTH: 466px">
	<tr>
		<td align="center">
		<font size="2" face="verdana"  color="SteelBlue"><b>En estos Momento No se encuentran Disponibles Tarjetas por el Monto solicitado.</b></font><br><br>
