...
<body border="0" style="margin: -20 -1 -1 -1" background="AFEX.jpg" bgcolor="#f6f6f6" style="background-repeat: no-repeat">
		<table cellspacing="2" cellpadding="1" style="BORDER-BOTTOM: lightgrey 0px solid">
			...
			<tr>
				<td>
					<object align="left" id="objEUR" style="HEIGHT: <%=nHeight%>px; WIDTH: 169px" type="text/x-scriptlet" width="174" border="0" VIEWASTEXT><param NAME="Scrollbar" VALUE="0"><param NAME="URL" VALUE="http:VisorAP.asp?mn=eur&vpr1=1&vpr2=<%=Request("vpr2")%>&co=1&ve=3"></object>
				</td>
			</tr>
			<tr>
