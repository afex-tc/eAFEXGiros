...
Select Case Request("Accion")
	...
	'	set rs = nothing
		...
		sSQL = "InsertarTransferencia " & sBancoOrigen & ", " & evaluarstr(Session("CodigoCliente")) & ", " & _ 
					...
					"2, 1, null, " & evaluarstr(sCuentaOrigen) & ", " & trim(request.Form("cbxBancodestino")) & ", " & evaluarstr(trim(request.Form("txtBanco"))) & ", " & _
					...
					evaluarstr(sEjecutivo) & ", null, 1, " & formatonumerosql(ccur(trim(request("Tarifa")))) & ", " & formatonumerosql(ccur(trim(request("Tarifa")))) & ", " & _ 
