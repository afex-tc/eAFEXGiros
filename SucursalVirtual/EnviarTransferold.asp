...
'	End If
%>
<!--#INCLUDE FILE="../Agente/Constantes.asp" -->
<!--#INCLUDE FILE="../Sucursal/Rutinas.asp" -->
<%
...
%>
<!--#INCLUDE FILE="../Compartido/Transferencias.asp" -->
...
<!--
	...
	Function ValidarDatos()
		...
		if frmTransfer.txtABA.value <> "" then frmTransfer.txtABA.value = "FW-" & trim(frmTransfer.txtABA.value)
		if frmTransfer.txtSWIFT.value <> "" Then frmTransfer.txtABA.value = trim(frmTransfer.txtABA.value) & "SA-" & trim(frmTransfer.txtSWIFT.value)
		if frmTransfer.txtCHIPS.value <> "" then frmTransfer.txtDireccionBanco.value = frmTransfer.txtDireccionBanco.value & _
												"   CH-" & trim(frmTransfer.txtCHIPS.value)
		if frmTransfer.txtIBAN.value <> "" then frmTransfer.txtCtaCte.value = trim(frmTransfer.txtIBAN.value)				
            ...
            <table border="0">
              ...
              <tr>
                ...
                <td colspan="2"><span class="textoempresa">Nombre Banco</span><br>
                    <input type="hidden" style="HEIGHT: 22px; TEXT-ALIGN: left; WIDTH: 200px" name="txtBanco" onKeyPress="IngresarTexto(2)" value="<%=request.Form("txtBanco")%>">
                    <select name="cbxBancoDestino" class="Borde_tabla_abajo">
                      <%CargarBanco sBanco%>
                    </select>                
                </td>
              </tr>
			  ...
			  <tr>
				<td>
                    ...
                    <input name="txtDireccionB" class="Borde_tabla_abajo" style="HEIGHT: 18px; TEXT-ALIGN: left; WIDTH: 200px" onKeyPress="IngresarTexto(2)" value="<%=request.Form("txtDireccionB")%>">
				</td>				
              </tr>
              <tr>
                ...
                <td colspan="2"><span class="textoempresa">Ciudad del Banco</span><br>
                    <input type="text" class="Borde_tabla_abajo" style="HEIGHT: 18px; TEXT-ALIGN: left; WIDTH: 200px" name="txtCiudadBanco" onKeyPress="IngresarTexto(2)" value="<%=request.Form("txtCiudadBanco")%>">                    
               </td>
              </tr>              
              <tr>
          ...
          <table id="tlbBIntermedio" border="0" style="display: none">
              ...
              <tr>
                <td><span class="textoempresa">Nombre del Banco</span><br>
                    <input type="hidden" class="Borde_tabla_abajo" style="HEIGHT: 18px; TEXT-ALIGN: left; WIDTH: 100px" name="txtBancoInt" onKeyPress="IngresarTexto(2)" value="<%=request.Form("txtBancoInt")%>">
                    <select class="Borde_tabla_abajo" name="cbxBancoDestinoInt">
              ...
              <tr>
                <td><span class="textoempresa">Dirección del Banco</span><br>
                    <input style="HEIGHT: 18px; TEXT-ALIGN: left; WIDTH: 200px" name="txtDireccionBancoInt" class="Borde_tabla_abajo" onKeyPress="IngresarTexto(2)" value="<%=request.Form("txtDireccionBancoInt")%>">                </td>
                <td><span class="textoempresa">Ciudad del Banco</span><br>
                    <input type="text" style="HEIGHT: 18px; TEXT-ALIGN: left; WIDTH: 115px" name="txtCiudadBancoInt" class="Borde_tabla_abajo" onKeyPress="IngresarTexto(2)" value="<%=request.Form("txtCiudadBancoInt")%>">
...
<!--#INCLUDE FILE="../Compartido/Rutinas.htm" -->
<!--#INCLUDE FILE="../Compartido/Transferencias.htm" -->
</html>
