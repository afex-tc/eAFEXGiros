...
<!--
	Function imgPrincipal_onclick()
		window.open "../NuevoCliente", "Principal"
	End Function
...
<h1 STYLE="COLOR: #3d78ad; FONT-SIZE: 80pt; LEFT: -6px; POSITION: absolute; TOP: -50px">Sucursal</h1>
<h1 STYLE="COLOR: #205987; FONT-FAMILY: Verdana; FONT-SIZE: 30pt; LEFT: 17px; POSITION: absolute; TOP: 8px">Sucursal</h1>
<%	If Session("ModoPrueba") Then %>
		<h1 STYLE="COLOR: aliceblue; FONT-FAMILY: Verdana; FONT-SIZE: 30pt; LEFT: 14px; POSITION: absolute; TOP: 5px">Sucursal (mp)</h1>
<% Else %>
		<h1 STYLE="COLOR: aliceblue; FONT-FAMILY: Verdana; FONT-SIZE: 30pt; LEFT: 14px; POSITION: absolute; TOP: 5px">Sucursal</h1>
<% End If %>
<p>
<!--<object height="20" id="objTab" style="HEIGHT: 20px; LEFT: 0px; POSITION: absolute; TOP: 60px; WIDTH: 99px" type="text/x-scriptlet" VIEWASTEXT><param NAME="Scrollbar" VALUE="0"><param NAME="URL" VALUE="http:../Scriptlets/Tab.htm"></object>-->
</p>
...
<script language="vbscript">
	...
	Sub window_onload()
		'objtab.agregar "NuevoCliente", "../Sucursal/NuevoCliente.asp", "Principal", 2
	End Sub
